...
DROP TABLE IF EXISTS training.dim_terminals CASCADE;
DROP TABLE IF EXISTS training.dim_clients CASCADE;
DROP TABLE IF EXISTS training.dim_accounts CASCADE;
DROP TABLE IF EXISTS training.dim_cards CASCADE;
...
CREATE TABLE training.dim_terminals (
...
CREATE TABLE training.dim_clients (
...
CREATE TABLE training.dim_accounts (
    account_num  VARCHAR(50)  PRIMARY KEY,
    valid_to     TIMESTAMP(6) NOT NULL,
    client       VARCHAR(50)  REFERENCES training.dim_clients (client_id),
...
CREATE TABLE training.dim_cards (
    card_num     VARCHAR(50)  PRIMARY KEY,
    account_num  VARCHAR(100) REFERENCES training.dim_accounts (account_num),
...
CREATE TABLE training.fact_transactions (
    ...
    card_num    VARCHAR(50)   REFERENCES training.dim_cards (card_num),
    oper_type   VARCHAR(50)   NOT NULL,
    amt         NUMERIC(10,2) NOT NULL,
    oper_result VARCHAR(50)   NOT NULL,
    terminal    VARCHAR(50)   REFERENCES training.dim_terminals (terminal_id)
    )
DISTRIBUTED RANDOMLY
